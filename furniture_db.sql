...
('Giường Diệp Mộc', 'Giường Diệp Mộc mang lại thiết kế dịu mắt với màu xanh nhẹ nhàng, tạo nên không gian êm ái và dễ chịu cho phòng ngủ của bạn.', 5900000.00, 8, '/upload/giuong-diep-moc.jpg', 'GIUONG-MDF-001', '180cm x 200cm', 'Gỗ MDF', 1),
('Giường Vải Nhung', 'Giường Vải Nhung được thiết kế để mang đến sự kết hợp hoàn hảo giữa phong cách hiện đại tối giản và sự thoải mái tối đa.', 7200000.00, 10, '/upload/giuong-nhung.jpg', 'GIUONG-KHUNG-GO-TU-NHIEN-002', '140cm x 200cm', 'Vải nhung, khung gỗ tự nhiên', 1),
('Giường Da', 'Giường da được thiết kế để mang đến sự kết hợp hoàn hảo giữa chất liệu da PU cao cấp và phong cách hiện đại, mang lại sự thoải mái và đẳng cấp cho không gian sống của bạn.', 8500000.00, 5, '/upload/giuong-da.jpg', 'GIUONG-KHUNG-GO-TU-NHIEN-003', '180cm x 200cm', 'Vải da, khung gỗ tự nhiên', 1),
('Giường Gỗ MDF', 'Thiết kế giường hộp tối giản không chỉ tạo ra vẻ đẹp thanh lịch mà còn giải quyết vấn đề của việc rơi đồ cá nhân dưới giường, nhờ việc loại bỏ chân giường.', 4800000.00, 12, '/upload/giuong-mdf.jpg', 'GIUONG-MDF-002', '180cm x 200cm', 'Gỗ MDF', 1),
